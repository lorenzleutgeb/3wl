...
Correctness of the new algorithm is shown. The first known implementation -- part of the lazy-grounding ASP system \enquote{Alpha} -- was used to evaluate performance with freely available input programs. Results are discussed.
\end{abstract}
